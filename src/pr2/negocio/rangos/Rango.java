...
*/
	...
	public void insertaRango(String cadena)
	{
		...
		if(cadena.equalsIgnoreCase(Constantes.RANDOM))
		{
			Random r = new Random();
			matriz[r.nextInt(Tam)][r.nextInt(Tam)].setIncluido(true);
			return;
		}
		else if(cadena.equalsIgnoreCase(Constantes.SUITED))
		{
			this.anySuited();
			return;
		}
		else if(cadena.equalsIgnoreCase(Constantes.OFFSUITED))
		{
			this.anyOffSuited();
			return;
		}
		else if(cadena.equalsIgnoreCase(Constantes.BROADWAY))
		{
			this.broadway();
			return;
		}
		else if(cadena.equalsIgnoreCase(Constantes.BROADWAY_SUITED))
		{
			this.broadwaySuited();
			return;
		}
		else if(cadena.equalsIgnoreCase(Constantes.BROADWAY_OFFSUITED))
		{
			this.broadwayOffSuited();
			return;
		}
		
		else if(cadena.equalsIgnoreCase(Constantes.NO_BROADWAY))
		{
			this.nobroadway();
			return;
		}
		else if(cadena.equalsIgnoreCase(Constantes.NO_BROADWAY_SUITED))
		{
			this.nobroadwaySuited();
			return;
		}
		else if(cadena.equalsIgnoreCase(Constantes.NO_BROADWAY_OFFSUITED))
		{
			this.nobroadwayOffSuited();
			return;
		}
		else if(cadena.equalsIgnoreCase(Constantes.ALL))
		{
			this.all();
			return;
		}
		else if(cadena.equalsIgnoreCase(Constantes.SUITED_CONECTORS))
		{
			this.suitedConectors();
			return;
		}
		else if(cadena.equalsIgnoreCase(Constantes.BROADWAY_CONECTORS))
		{
	...
	{
		for(int i=Constantes.T;i<Tam;i++)
		{
			int j= i;//+1;
			for(;j<Tam;j++)
	...
	{
		for(int i=Constantes.T;i<Tam;i++)//filas
		{
			int j=i;//+1;
			for(;j<Tam;j++)//filas
				insertaRango(i,j);//matriz[i][j].setIncluido(true);
	...
	{
		for(int i=0 ; i<Constantes.T;i++)//filas
		{
			int j=i;//+1;
			for(;j<Constantes.T;j++)//filas
				insertaRango(j,i);//matriz[j][i].setIncluido(true);
		}
	}
